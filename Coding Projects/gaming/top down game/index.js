...
function animate() {
    ...
    background.draw()
    c.drawImage(playerImage, 0, 0, playerImage.width / 12, playerImage.height / 8, canvas.width / 2 - (playerImage.width / 12) / 2, canvas.height / 2 - (playerImage.height / 4) / 2, playerImage.width / 12, playerImage.height / 8)
